...
#GillKieren_Assign9_problem1.py
...
#obtain the length of the list and print it
list_length = len(challenge1)
print(list_length)
#obtain the sum of the values in the list and print it
sum_list = sum(challenge1)
print(sum_list)
#calculate the average of the values in the list and print it
average = sum_list/list_length
print(average)
#find the largest value and print it
largest = max(challenge1)
print(largest)
#find the smallest value and print it
smallest = min(challenge1)
print(smallest)
#we got the first key! add it to the list of keys
print()
print('key 1: "quartz"')
key.append("quartz")
...
#create a for loop that iterates across the length of the list
#make a counter and set it to zero
#if a number is in an even location, add it to the counter
#that will be the latitude!
latitude_1 = 0
for i in range(0,len(challenge2a)):
    if (i+2)%2==0:
        latitude_1 += challenge2a[i]

#create a for loop that iterates across the length of the list
#make a counter and set it to zero
#if a number is in an odd location, add it to the counter
#that will be the longitude!
longitude_1 = 0
for i in range(0,len(challenge2a)):
    if (i+2)%2!=0:
        longitude_1 += challenge2a[i]
...
#that will be the latitude!
latitude_2 = 0
for i in range(0,len(challenge2b)):
    if (i+2)%2==0:
        latitude_2 += challenge2b[i]
...
print()
#we got the second key! add it to the list of keys
print('key 2: "moonstone"')
key.append("moonstone")
...
#find the largest value in the list and print it
largest = max(challenge3)
print(largest)

#create a counter and set it to zero
max_repeated=0
#create a for loop which iterates through the list
#if the max number is in the list
...
#sort the list
challenge3_sorted = sorted(challenge3)
#create a new list and append everything except the largest number (80)
challenge3_new =[]
for i in challenge3_sorted:
    if i != 80:
        challenge3_new.append(i)

#find the new largest number and print it out
new_largest = max(challenge3_new)
print (new_largest)

#create a counter and set it to zero
second_largest_repeated=0
#create a for loop which iterates through the list
#if the max number is in the list
#add one to the counter
for i in challenge3_new:
    if i == new_largest:
        second_largest_repeated += 1
#print out the second largest number
print(second_largest_repeated)

#find the first location of the largest number
location_1 = challenge3.index(80)
print(location_1)

#reverse the list
#find how far from the back was the last occurence of the second largest number
#add 1 because list indexing starts with zero
#subtract the number we get from the length of the list
#to get the actual location of the number
challenge3.reverse()
location_2 = challenge3.index(79)+1
real_location_2 = len(challenge3)-location_2
print(real_location_2)

print()
#we got the third key! add it to the list of keys
print('key 3: "ruby"')
key.append("ruby")


print()
#let users know what the keys are
...
#"treasurelieswithinthischest"

#create a counter and set it to zero
final_sum = 0
#create a for loop which iterates through the string
#convert each character to its acsii value and subtract it by 97
#this aligns with the decoding standard stated in the challenge
#add the values to the counter
for character in "treasurelieswithinthischest":
    subtotal = ord(character)-97
    final_sum += subtotal

print(final_sum)
#create a for loop
#subtract each value in challenge4 by the final_sum we obtained
#the new values replace the old values in the challenge4 list
for i in challenge4:
    new_num = i - final_sum
    challenge4[challenge4.index(i)] = new_num

#create a for loop
#for each value in challenge4, add it by 97 to obtain its ascii value
#and convert it to its corresponding character
#these new characters replace the old values in the challenge4 list
for i in challenge4:
    new_letter =chr(i+97)
    challenge4[challenge4.index(i)] = new_letter

#create a for loop and a counter
#concatenate each character in the counter
#final pasword is... emerald!
final_password=''
for i in challenge4:
    final_password +=i
